                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [BoxShadow(color: AppTheme.primaryColor.withAlpha((0.3 * 255).toInt()), blurRadius: 12, spreadRadius: 2)],
                            ),
            ...
            SliverPadding(
              ...
              sliver: SliverGrid(
                gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                  ...
                  crossAxisSpacing: 16,
                  mainAxisSpacing: 16,
                  childAspectRatio: 1.1, // Increased from 1.2 to 1.1 for more height
                ),
                delegate: SliverChildListDelegate([
                  _QuickActionCard(
              ...
              sliver: SliverList(
                delegate: SliverChildListDelegate([
                  ...
                  Container(
                    ...
                    padding: const EdgeInsets.all(AppConstants.paddingLarge),
                    decoration: BoxDecoration(
                      gradient: LinearGradient(begin: Alignment.topLeft, end: Alignment.bottomRight, colors: [Colors.white, Colors.white.withAlpha((0.9 * 255).toInt())]),
                      borderRadius: BorderRadius.circular(20),
                      boxShadow: [BoxShadow(color: Colors.black.withAlpha((0.05 * 255).toInt()), blurRadius: 20, spreadRadius: 5)],
                    ),
                    child: Column(
    ...
    return GestureDetector(
      ...
      child: Container(
        decoration: BoxDecoration(
          gradient: gradient,
          borderRadius: BorderRadius.circular(20),
          boxShadow: [BoxShadow(color: gradient.colors.first.withAlpha((0.3 * 255).toInt()), blurRadius: 12, spreadRadius: 2)],
        ),
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Icon(icon, color: Colors.white, size: 28), // Reduced size from 32 to 28
