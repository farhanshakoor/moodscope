                          ...
                          GestureDetector(
                                ...
                                child: AnimatedContainer(
                                  ...
                                  decoration: BoxDecoration(
                                    gradient: isSelected ? LinearGradient(colors: [emotionColor.withValues(alpha: 0.8), emotionColor]) : null,
                                    color: isSelected ? null : Colors.white,
                                    borderRadius: BorderRadius.circular(25),
                                    border: Border.all(color: isSelected ? emotionColor : Colors.grey.shade200, width: isSelected ? 2 : 1),
                                    boxShadow: [
                                      if (isSelected)
                                        BoxShadow(color: emotionColor.withValues(alpha: 0.3), blurRadius: 12, spreadRadius: 2)
                                      else
                              ...
                              .shimmer(duration: 1500.ms, color: isSelected ? Colors.white.withValues(alpha: 0.3) : null),
                    )
                    .animate()
                    .slideX(
                      begin: 0.3,
