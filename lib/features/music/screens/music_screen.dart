      ...
      child: SafeArea(
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('Music that matches your mood', style: Theme.of(context).textTheme.bodyLarge?.copyWith(color: AppTheme.textSecondary)),
                ],
              ),
                ...
                child: TextField(
                  ...
                  onSubmitted: (value) async {
                    if (value.trim().isNotEmpty) {
                      final results = await context.read<MusicProvider>().searchTracks(value.trim());
            ...
            ).animate().slideX(begin: -0.3, delay: 400.ms, duration: 600.ms, curve: Curves.easeOut).fadeIn(delay: 400.ms),
                    ...
                    return const Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 16),
                          Text('Finding perfect songs for you...', style: TextStyle(color: AppTheme.textSecondary, fontSize: 16)),
                        ],
                      ),
                    );
                  }
                    ...
                    return Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 16),
                          Text('No music recommendations', style: Theme.of(context).textTheme.titleLarge?.copyWith(color: AppTheme.textSecondary)),
                          const SizedBox(height: 8),
                          Text(
                      ...
                      Expanded(
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return MusicTrackCard(track: track, onPlay: () => musicProvider.playTrack(track))
                                .animate()
                                .slideX(
                                  begin: 0.3,
                                ...
                                .fadeIn(delay: Duration(milliseconds: index * 100 + 600));
                          },
                        ),
                      ),
                    ],
